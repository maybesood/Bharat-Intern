...
// java script is a single threaded language-- it means that it runs one line of code at a time
//async await- await keyword pauses the execution and waits for some resolved time as given 

// use of params it is used to grab a specific parameter. like 
// app.post("/like/:postId", isLoggedIn,async function(req, res) 